...
class ParticipantAdapter(participantList: ArrayList<ParticipantItem>) : RecyclerView.Adapter<ParticipantAdapter.ParticipantViewHolder>() {
    private val listeParticipants: ArrayList<ParticipantItem>
    ...
    override fun onBindViewHolder(holder: ParticipantViewHolder, position: Int) {
        val currentItem: ParticipantItem = listeParticipants[position]
        holder.textViewNomParticipant.text = currentItem.nomParticipant
    }
